          ...
          {items.map((item) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-3 p-3 rounded-xl bg-eco-surface/50 border border-white/5
                  cursor-pointer hover:border-eco-green/20 transition-all"
              >
                ...
                <span className="text-[12px] font-semibold text-eco-green">{item.co2}</span>
              </div>
            )
          })}
        </motion.div>
